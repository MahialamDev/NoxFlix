...
export default function LoginPage() {
  ...
  function handleSubmit(e) {
    ...
    alert("Login submitted — connect your auth provider!");
  }
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 pt-16">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          <h1 className="text-white text-2xl font-black mb-6">Sign In</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="#" className="text-red-500 hover:text-red-400 text-xs transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            <button
              type="submit"
              className="w-full bg-red-600 hover:bg-red-700 text-white font-black py-3 rounded-xl transition-colors text-sm shadow-lg shadow-red-900/30"
            >
              Sign In
            </button>
          </form>
